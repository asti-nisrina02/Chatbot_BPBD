...
REF_ANGIN = (
    "- Angin Puting Beliung berkaitan dengan: Angin Kencang, Bangunan kokoh, Bangunan kokoh, Infrastruktur, Rumah\n"
...
REF_PUTING_BERULANG = "Tidak ada konteks ditemukan."
...
REF_ABU = (
    "- BENCANA KABUPATEN BOGOR berkaitan dengan: wilayah Kabupaten Bogor, Kabupaten Bogor, kerusuhan sosial, konflik sosial\n"
    "- gunungapi berkaitan dengan: abu vulkanik\n"
    "- Gunung Berapi berkaitan dengan: Danau Kawah\n"
...
REF_LAHAR_DINGIN = "Tidak ada konteks ditemukan."

REF_KARHUTLA_BESAR = (
    "- Pemadam Kebakaran berkaitan dengan: Pusdatin BPBD Kab. Bogor, BPBD Kab. Bogor\n"
...
REF_KARHUTLA_KECIL = "- karhutla berkaitan dengan: lahan, partikulat (PM10)"

REF_KEKERINGAN = "- Kekeringan berkaitan dengan: Penyakit, Kekeringan, Air bersih, Waduk/embung, Sumur resapan/biopori"
...
REF_MITIGASI_BENCANA = (
    "- Kesiapsiagaan Bencana berkaitan dengan: Keselamatan\n"
    "- posko layanan bencana berkaitan dengan: pelatihan penyelamatan diri, bencana\n"
    "- Bencana Alam berkaitan dengan: penyandang disabilitas, kondisi fisik dan mental\n"
    "- Latihan Mitigasi berkaitan dengan: Partisipasi\n"
    "- Bencana berkaitan dengan: korban jiwa manusia, kerusakan lingkungan, kerugian harta benda, dampak psikologis, peristiwa atau rangkaian peristiwa\n"
    "- Bencana alam berkaitan dengan: gempa bumi, letusan gunung berapi, angin topan, tanah longsor, kekeringan\n"
    "- Bencana non-alam berkaitan dengan: kebakaran hutan/lahan, kecelakan transportasi, kegagalan konstruksi/teknologi, dampak industri, ledakan\n"
    "- BENCANA KABUPATEN BOGOR berkaitan dengan: wilayah Kabupaten Bogor, Kabupaten Bogor, kerusuhan sosial, konflik sosial\n"
    "- bencana alam berkaitan dengan: penyandang disabilitas, kondisi\n"
    "- bencana berkaitan dengan: lokasi bencana, air banjir\n"
    ...
    "- Penyusunan pengkajian mitigasi berkaitan dengan: Saat dan pasca bencana\n"
...
REF_KESIAPSIAGAAN = (
    "- Rencana Kesiapsiagaan berkaitan dengan: TSB, Tiga upaya utama\n"
    "- Kesiapsiagaan Bencana berkaitan dengan: Keselamatan\n"
    "- posko layanan bencana berkaitan dengan: pelatihan penyelamatan diri, bencana\n"
    "- Bencana Alam berkaitan dengan: penyandang disabilitas, kondisi fisik dan mental\n"
    "- Bidang Pencegahan & Kesiapsiagaan berkaitan dengan: Kegiatan Mitigasi\n"
    "- Bencana berkaitan dengan: korban jiwa manusia, kerusakan lingkungan, kerugian harta benda, dampak psikologis, peristiwa atau rangkaian peristiwa\n"
    "- Bencana alam berkaitan dengan: gempa bumi, letusan gunung berapi, angin topan, tanah longsor, kekeringan\n"
    "- Bencana non-alam berkaitan dengan: kebakaran hutan/lahan, kecelakan transportasi, kegagalan konstruksi/teknologi, dampak industri, ledakan\n"
    "- BENCANA KABUPATEN BOGOR berkaitan dengan: wilayah Kabupaten Bogor, Kabupaten Bogor, kerusuhan sosial, konflik sosial\n"
    "- Kesiapsiagaan berkaitan dengan: Bencana, Rute Evakuasi, Latihan Gladi Simulasi, Nomor Kontak Penting, Analisis Ancaman\n"
    "- bencana alam berkaitan dengan: penyandang disabilitas, kondisi\n"
    "- bencana berkaitan dengan: lokasi bencana, air banjir\n"
    "- PetaBencana.id berkaitan dengan: informasi\n"
    "- tas siaga bencana berkaitan dengan: air minum, makanan\n"
    "- Pusat Vulkanologi dan Mitigasi Bencana Geologi (PVMBG) berkaitan dengan: Geologi\n"
    "- Pra Bencana berkaitan dengan: Pergeseran Tanah\n"
    "- Bidang Pencegahan dan Kesiapsiagaan berkaitan dengan: Pengecoordinasian, Mitigasi, Kepala Pelaksana\n"
    "- Mitigasi bencana berkaitan dengan: Tahap prabencana\n"
    "- Daerah Rawan Bencana berkaitan dengan: Pemukiman"
)
...
REF_NOMOR_DARURAT = (
    "- Kesiapsiagaan Bencana berkaitan dengan: Keselamatan\n"
    "- tas darurat berkaitan dengan: alat-alat kebutuhan hewan, alat-alat kebutuhan hewan\n"
    "- posko layanan bencana berkaitan dengan: pelatihan penyelamatan diri, bencana\n"
    "- Bencana Alam berkaitan dengan: penyandang disabilitas, kondisi fisik dan mental\n"
    "- Bidang Kedaruratan & Logistik berkaitan dengan: Asesment\n"
    "- Bencana berkaitan dengan: korban jiwa manusia, kerusakan lingkungan, kerugian harta benda, dampak psikologis, peristiwa atau rangkaian peristiwa\n"
    "- Bencana alam berkaitan dengan: gempa bumi, letusan gunung berapi, angin topan, tanah longsor, kekeringan\n"
    "- Bencana non-alam berkaitan dengan: kebakaran hutan/lahan, kecelakan transportasi, kegagalan konstruksi/teknologi, dampak industri, ledakan\n"
    "- BENCANA KABUPATEN BOGOR berkaitan dengan: wilayah Kabupaten Bogor, Kabupaten Bogor, kerusuhan sosial, konflik sosial\n"
    ...
    "- tas siaga bencana berkaitan dengan: air minum, makanan\n"
    "- Pusat Vulkanologi dan Mitigasi Bencana Geologi (PVMBG) berkaitan dengan: Geologi\n"
    "- tangga darurat berkaitan dengan: evakuasi\n"
    "- Pra Bencana berkaitan dengan: Pergeseran Tanah\n"
    "- Mitigasi bencana berkaitan dengan: Tahap prabencana\n"
    "- Daerah Rawan Bencana berkaitan dengan: Pemukiman"
)
...
REF_TITIK_KUMPUL = (
    ...
    "- Titik Kumpul berkaitan dengan: Rencana Kesiapsiagaan"
)

REF_JALUR_EVAKUASI = (
    "- Rute Evakuasi berkaitan dengan: Pengetahuan\n"
...
pertanyaan_dataset = [
    ...
    {'question': 'Apa yang harus dilakukan saat terjadi hujan abu vulkanik?', 'reference': REF_ABU_HUJAN},
    {'question': 'Bagaimana cara melindungi pernapasan dari abu vulkanik?', 'reference': REF_ABU_HUJAN},
    {'question': 'Apakah abu vulkanik berbahaya bagi kesehatan?', 'reference': REF_ABU_HUJAN},
    ...
    {'question': 'Apa itu mitigasi bencana?', 'reference': REF_MITIGASI_BENCANA},
    {'question': 'Apa peran BPBD dalam penanggulangan bencana?', 'reference': REF_PERAN_BPBD},
    {'question': 'Apa yang dimaksud dengan kesiapsiagaan bencana?', 'reference': REF_KESIAPSIAGAAN},
    {'question': 'Berapa nomor darurat yang harus dihubungi saat bencana?', 'reference': REF_NOMOR_DARURAT},
    {'question': 'Apa itu titik kumpul dan apa fungsinya?', 'reference': REF_TITIK_KUMPUL},
    {'question': 'Apa yang dimaksud dengan jalur evakuasi?', 'reference': REF_JALUR_EVAKUASI},
    {'question': 'Apa saja tahapan pasca bencana?', 'reference': REF_TAHAPAN_PASCA_BENCANA},
]
...
# Ditambahkan 'kumpul' dan 'kesiapsiagaan' agar pertanyaan umum/BPBD
# bisa mengambil konteks dari dokumen baru (bencana.pdf, kesiapsiagaan.pdf, nomor_darurat.pdf)
